...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6">
                <div class="card-body mx-auto text-center p-5 border border-dark-subtle bg-white"
                    style="border-radius: 20px">
                    <h5 class="head-text text-center fs-2">Login</h5>
                    <br>
                    <form action="{{ route('login.voter') }}" method="POST" enctype="multipart/form-data">
                        @csrf
