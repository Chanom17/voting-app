        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6 ">
                <div class="card-body mx-auto text-end p-5 border border-dark-subtle">
                    <h5 class="head-text text-center fs-2">Add Candidate</h5>
                    <br>
                    <form action="{{ route('candidate.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <img id="previewImg" src="" alt="image" style="max-width: 200px; display:block;"
                            class="mx-auto">
                        <br>
                        <div class="form-group row">
                        ...
                        <br>
                        @if (Session::has('Candidate_Added'))
                            <div class="alert alert-success text-center">{{ Session::get('Candidate_Added') }}</div>
                        @endif
                    </form>
                </div>
            </div>
