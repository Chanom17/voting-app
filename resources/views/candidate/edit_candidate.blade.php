        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6 ">
                <div class="card-body mx-auto text-end p-5 border border-dark-subtle">
                    <h5 class="head-text text-center fs-2">Edit Candidate</h5>
                    <br>
                    <form action="{{ route('candidate.update', $candidate->id) }}" method="POST"
                        ...
                        <br>
                        <img id="previewImg" src="{{ asset('images') }}/{{ $candidate->image }}" alt="image"
                            style="max-width: 200px; display:block;" class="mx-auto">
                        <br>
                        <div class="form-group row">
                            <label for="image" class="col-sm-4 col-form-label">Choose Image :</label>
                            <div class="col-sm-8">
                        ...
                        <br>
                        @if (Session::has('Candidate_Updated'))
                            <div class="alert alert-success text-center">{{ Session::get('Candidate_Updated') }}</div>
                        @endif
                    </form>
                </div>
            </div>
